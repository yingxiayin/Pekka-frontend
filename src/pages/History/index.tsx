...
import roadImg from '@/assets/img/history/history_road_img.png'
            ...
            <div className={styles.three_content_area}>
              <div className={styles.three_people_item}>
                ...
                <div className={styles.three_people_item_area}>
                  <img className={styles.three_people_item_img} src={peopleImg} alt='peopleImg'/>
                  <div className={styles.three_people_item_name}>Mike Williams
                    <span style={{fontWeight: 'normal', color: '#666666', display: 'block'}}>CEO</span>
                  </div>
                </div>
              </div>
              <div className={styles.three_people_item}>
