      ...
      <Layout className={styles.layout}>
        ...
        <Content>
          ...
          <div className={styles.content_two}>
            ...
            <div className={styles.two_content_area}>
              <div className={styles.two_content_p}>
                一个利用全球闲置显卡算力和分布式的云算力，通过
              </div>
              <div className={styles.two_content_p}>
                开发者创建服务的深度云计算服务平台，使用户可以轻松使用廉价且多样化
              </div>
              <div className={styles.two_content_p}>
                的渲染，边缘计算等服务来满足其商业需求
              </div>
          ...
          <div className={styles.content_three}>
            <div className={styles.content_three_title}>
              Pekicr将通过区块链把终端用户、技术开发者、算力提供商和营销者统一在一个生态系统中，并扮演好各自的角色
            </div>
